...
type RegisterRequest struct {
	...
	MerchantUuid  string                 `protobuf:"bytes,6,opt,name=merchant_uuid,json=merchantUuid,proto3" json:"merchant_uuid,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *RegisterRequest) GetMerchantUuid() string {
	if x != nil {
...
func (x *RegisterResponse) GetRoleId() string {
	if x != nil {
		return x.RoleId
	}
	return ""
...
func (x *ResendActivationCodeRequest) Reset() {
	*x = ResendActivationCodeRequest{}
	mi := &file_auth_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ResendActivationCodeRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ResendActivationCodeRequest) ProtoMessage() {}

func (x *ResendActivationCodeRequest) ProtoReflect() protoreflect.Message {
	mi := &file_auth_proto_msgTypes[12]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ResendActivationCodeRequest.ProtoReflect.Descriptor instead.
func (*ResendActivationCodeRequest) Descriptor() ([]byte, []int) {
	return file_auth_proto_rawDescGZIP(), []int{12}
}

func (x *ResendActivationCodeRequest) GetEmail() string {
	if x != nil {
		return x.Email
	}
	return ""
...
func (x *ResendActivationCodeResponse) Reset() {
	*x = ResendActivationCodeResponse{}
	mi := &file_auth_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ResendActivationCodeResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ResendActivationCodeResponse) ProtoMessage() {}

func (x *ResendActivationCodeResponse) ProtoReflect() protoreflect.Message {
	mi := &file_auth_proto_msgTypes[13]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ResendActivationCodeResponse.ProtoReflect.Descriptor instead.
func (*ResendActivationCodeResponse) Descriptor() ([]byte, []int) {
	return file_auth_proto_rawDescGZIP(), []int{13}
}

func (x *ResendActivationCodeResponse) GetIsSuccess() bool {
	if x != nil {
		return x.IsSuccess
	}
	return false
...
func (x *ForgotPasswordResponse) GetIsSuccess() bool {
	if x != nil {
		return x.IsSuccess
	}
	return false
...
func (x *ResetPasswordRequest) GetConfirmationPassword() string {
	if x != nil {
		return x.ConfirmationPassword
	}
	return ""
...
const file_auth_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"auth.proto\x12\aauth.v2\x1a\x1fgoogle/protobuf/timestamp.proto\"@\n" +
	...
	"\rmerchant_name\x18\x05 \x01(\tR\fmerchantName\x12\x1b\n" +
	...
	"\n" +
	"is_success\x18\x01 \x01(\bR\tisSuccess2\x86\b\n" +
	"\vAuthService\x126\n" +
	"\x05Login\x12\x15.auth.v2.LoginRequest\x1a\x16.auth.v2.LoginResponse\x12K\n" +
	"\fRefreshToken\x12\x1c.auth.v2.RefreshTokenRequest\x1a\x1d.auth.v2.RefreshTokenResponse\x12?\n" +
	"\bRegister\x12\x18.auth.v2.RegisterRequest\x1a\x19.auth.v2.RegisterResponse\x12Q\n" +
	"\x0eCreatePassword\x12\x1e.auth.v2.CreatePasswordRequest\x1a\x1f.auth.v2.CreatePasswordResponse\x12c\n" +
	"\x14ResendActivationCode\x12$.auth.v2.ResendActivationCodeRequest\x1a%.auth.v2.ResendActivationCodeResponse\x12Q\n" +
	"\x0eForgotPassword\x12\x1e.auth.v2.ForgotPasswordRequest\x1a\x1f.auth.v2.ForgotPasswordResponse\x12N\n" +
	"\rResetPassword\x12\x1d.auth.v2.ResetPasswordRequest\x1a\x1e.auth.v2.ResetPasswordResponse\x12Q\n" +
	"\x0eChangePassword\x12\x1e.auth.v2.ChangePasswordRequest\x1a\x1f.auth.v2.ChangePasswordResponse\x12I\n" +
	"\bValidate\x12\x1d.auth.v2.ValidateTokenRequest\x1a\x1e.auth.v2.ValidateTokenResponse\x12u\n" +
	"\x16ValidateActivationCode\x12,.auth.v2.CheckTokenActivationPasswordRequest\x1a-.auth.v2.CheckTokenActivationPasswordResponse\x12B\n" +
	...
	"\x06Logout\x12\x16.auth.v2.LogoutRequest\x1a\x17.auth.v2.LogoutResponseB8Z6gitlab.com/bykarya-proto/proto/gen/go/auth/v2;authpbv2b\x06proto3"
...
var file_auth_proto_goTypes = []any{
	...
	(*RegisterRequest)(nil),                      // 4: auth.v2.RegisterRequest
	(*RegisterResponse)(nil),                     // 5: auth.v2.RegisterResponse
	(*ValidateTokenRequest)(nil),                 // 6: auth.v2.ValidateTokenRequest
	(*ValidateTokenResponse)(nil),                // 7: auth.v2.ValidateTokenResponse
	(*VerifyOTPRequest)(nil),                     // 8: auth.v2.VerifyOTPRequest
	(*VerifyOTPResponse)(nil),                    // 9: auth.v2.VerifyOTPResponse
	(*ResendOTPRequest)(nil),                     // 10: auth.v2.ResendOTPRequest
	(*ResendOTPResponse)(nil),                    // 11: auth.v2.ResendOTPResponse
	(*ResendActivationCodeRequest)(nil),          // 12: auth.v2.ResendActivationCodeRequest
	(*ResendActivationCodeResponse)(nil),         // 13: auth.v2.ResendActivationCodeResponse
	(*CheckTokenActivationPasswordRequest)(nil),  // 14: auth.v2.CheckTokenActivationPasswordRequest
	(*CheckTokenActivationPasswordResponse)(nil), // 15: auth.v2.CheckTokenActivationPasswordResponse
	(*CreatePasswordRequest)(nil),                // 16: auth.v2.CreatePasswordRequest
	(*CreatePasswordResponse)(nil),               // 17: auth.v2.CreatePasswordResponse
	(*ForgotPasswordRequest)(nil),                // 18: auth.v2.ForgotPasswordRequest
	(*ForgotPasswordResponse)(nil),               // 19: auth.v2.ForgotPasswordResponse
	(*ResetPasswordRequest)(nil),                 // 20: auth.v2.ResetPasswordRequest
	(*ResetPasswordResponse)(nil),                // 21: auth.v2.ResetPasswordResponse
	(*ChangePasswordRequest)(nil),                // 22: auth.v2.ChangePasswordRequest
	(*ChangePasswordResponse)(nil),               // 23: auth.v2.ChangePasswordResponse
	(*LogoutRequest)(nil),                        // 24: auth.v2.LogoutRequest
	(*LogoutResponse)(nil),                       // 25: auth.v2.LogoutResponse
	(*timestamppb.Timestamp)(nil),                // 26: google.protobuf.Timestamp
}
var file_auth_proto_depIdxs = []int32{
	26, // 0: auth.v2.LoginResponse.expires_at:type_name -> google.protobuf.Timestamp
	26, // 1: auth.v2.RefreshTokenResponse.expires_at:type_name -> google.protobuf.Timestamp
	26, // 2: auth.v2.RegisterResponse.created_at:type_name -> google.protobuf.Timestamp
	0,  // 3: auth.v2.AuthService.Login:input_type -> auth.v2.LoginRequest
	2,  // 4: auth.v2.AuthService.RefreshToken:input_type -> auth.v2.RefreshTokenRequest
	4,  // 5: auth.v2.AuthService.Register:input_type -> auth.v2.RegisterRequest
	16, // 6: auth.v2.AuthService.CreatePassword:input_type -> auth.v2.CreatePasswordRequest
	12, // 7: auth.v2.AuthService.ResendActivationCode:input_type -> auth.v2.ResendActivationCodeRequest
	18, // 8: auth.v2.AuthService.ForgotPassword:input_type -> auth.v2.ForgotPasswordRequest
	20, // 9: auth.v2.AuthService.ResetPassword:input_type -> auth.v2.ResetPasswordRequest
	22, // 10: auth.v2.AuthService.ChangePassword:input_type -> auth.v2.ChangePasswordRequest
	6,  // 11: auth.v2.AuthService.Validate:input_type -> auth.v2.ValidateTokenRequest
	14, // 12: auth.v2.AuthService.ValidateActivationCode:input_type -> auth.v2.CheckTokenActivationPasswordRequest
	8,  // 13: auth.v2.AuthService.VerifyOTP:input_type -> auth.v2.VerifyOTPRequest
	10, // 14: auth.v2.AuthService.ResendOTP:input_type -> auth.v2.ResendOTPRequest
	24, // 15: auth.v2.AuthService.Logout:input_type -> auth.v2.LogoutRequest
	1,  // 16: auth.v2.AuthService.Login:output_type -> auth.v2.LoginResponse
	3,  // 17: auth.v2.AuthService.RefreshToken:output_type -> auth.v2.RefreshTokenResponse
	5,  // 18: auth.v2.AuthService.Register:output_type -> auth.v2.RegisterResponse
	17, // 19: auth.v2.AuthService.CreatePassword:output_type -> auth.v2.CreatePasswordResponse
	13, // 20: auth.v2.AuthService.ResendActivationCode:output_type -> auth.v2.ResendActivationCodeResponse
	19, // 21: auth.v2.AuthService.ForgotPassword:output_type -> auth.v2.ForgotPasswordResponse
	21, // 22: auth.v2.AuthService.ResetPassword:output_type -> auth.v2.ResetPasswordResponse
	23, // 23: auth.v2.AuthService.ChangePassword:output_type -> auth.v2.ChangePasswordResponse
	7,  // 24: auth.v2.AuthService.Validate:output_type -> auth.v2.ValidateTokenResponse
	15, // 25: auth.v2.AuthService.ValidateActivationCode:output_type -> auth.v2.CheckTokenActivationPasswordResponse
	9,  // 26: auth.v2.AuthService.VerifyOTP:output_type -> auth.v2.VerifyOTPResponse
	11, // 27: auth.v2.AuthService.ResendOTP:output_type -> auth.v2.ResendOTPResponse
	25, // 28: auth.v2.AuthService.Logout:output_type -> auth.v2.LogoutResponse
