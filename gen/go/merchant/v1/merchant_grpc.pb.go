...
const (
	MerchantService_GetAll_FullMethodName  = "/merchant.v1.MerchantService/GetAll"
	MerchantService_Create_FullMethodName  = "/merchant.v1.MerchantService/Create"
	MerchantService_Update_FullMethodName  = "/merchant.v1.MerchantService/Update"
	MerchantService_GetById_FullMethodName = "/merchant.v1.MerchantService/GetById"
)
...
type MerchantServiceClient interface {
	...
	Update(ctx context.Context, in *MerchantRequest, opts ...grpc.CallOption) (*MerchantResponse, error)
...
func (c *merchantServiceClient) Update(ctx context.Context, in *MerchantRequest, opts ...grpc.CallOption) (*MerchantResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(MerchantResponse)
...
type MerchantServiceServer interface {
	...
	Update(context.Context, *MerchantRequest) (*MerchantResponse, error)
...
func (UnimplementedMerchantServiceServer) Update(context.Context, *MerchantRequest) (*MerchantResponse, error) {
