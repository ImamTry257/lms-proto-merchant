...
type MerchantRequest struct {
	...
	OwnerRoleId      string                 `protobuf:"bytes,13,opt,name=owner_role_id,json=ownerRoleId,proto3" json:"owner_role_id,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *MerchantRequest) GetOwnerRoleId() string {
	if x != nil {
...
const file_merchant_proto_rawDesc = "" +
	...
	"\x03id_\x18\x01 \x01(\tR\x02id\"\x9a\x03\n" +
