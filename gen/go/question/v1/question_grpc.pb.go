...
const (
	QuestionService_GetAll_FullMethodName    = "/question.v1.QuestionService/GetAll"
	QuestionService_Create_FullMethodName    = "/question.v1.QuestionService/Create"
	QuestionService_Update_FullMethodName    = "/question.v1.QuestionService/Update"
	QuestionService_GetById_FullMethodName   = "/question.v1.QuestionService/GetById"
	QuestionService_GetByUuid_FullMethodName = "/question.v1.QuestionService/GetByUuid"
)
...
type QuestionServiceClient interface {
	...
	Create(ctx context.Context, in *QuestionRequest, opts ...grpc.CallOption) (*QuestionResponse, error)
	Update(ctx context.Context, in *QuestionRequest, opts ...grpc.CallOption) (*QuestionResponse, error)
...
func (c *questionServiceClient) Create(ctx context.Context, in *QuestionRequest, opts ...grpc.CallOption) (*QuestionResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *questionServiceClient) Update(ctx context.Context, in *QuestionRequest, opts ...grpc.CallOption) (*QuestionResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(QuestionResponse)
...
type QuestionServiceServer interface {
	...
	Create(context.Context, *QuestionRequest) (*QuestionResponse, error)
	Update(context.Context, *QuestionRequest) (*QuestionResponse, error)
...
func (UnimplementedQuestionServiceServer) Create(context.Context, *QuestionRequest) (*QuestionResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Create not implemented")
}
func (UnimplementedQuestionServiceServer) Update(context.Context, *QuestionRequest) (*QuestionResponse, error) {
