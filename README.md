...
protoc --proto_path=proto/merchant --go_out=gen/go/merchant --go_opt=paths=source_relative --go-grpc_out=gen/go/merchant --go-grpc_opt=paths=source_relative proto/merchant/merchant.proto
